    ...
    <nav className="relative bg-white px-3 py-4 shadow-md md:px-4 ">
      <Wrapper>
        <div className="flex items-center justify-between">
          ...
          <ul
            className={` z-60 absolute left-0 top-0 flex min-h-[100vh] w-[50%] flex-col  items-start md:items-center gap-12 bg-white/95  px-3 pt-10 font-lora text-lg duration-500 md:static md:min-h-fit md:w-auto md:flex-row md:bg-transparent md:pt-0 ${
